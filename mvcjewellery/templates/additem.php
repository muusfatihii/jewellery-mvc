...
<form method="POST" action="index.php?action=addItem" enctype="multipart/form-data">
    <div class="mb-3 chmp">
        <label for="nomproduit" class="form-label label-f">Nom</label>
        <input type="text" class="form-control" id="nomproduit" name="name" required>
    </div>
    <div class="mb-3 chmp">
    ...
    <div class="mb-3 chmp">
        ...
        <input type="nombre" class="form-control" id="quantiteproduit" name="quantity" required>
    </div>
    <div class="mb-3 chmp">
        <label for="prixproduit" class="form-label label-f">Prix</label>
        <input type="nombre" class="form-control" id="prixproduit" name="price" required>
    </div>


    <div class="mb-3">
        <label for="categorie" class="form-label label-f">Catégorie</label>
    ...
    <div class="mb-3 chmp">
        ...
        <textarea name="description" id="descriptionitem" cols="30" rows="4"></textarea>
    </div>
